...
mod tests {
    ...
    const SAMPLE_CASHU_TOKEN: &str = "";
    const SAMPLE_CASHU_TOKEN_NO_PAD: &str = "";
    ...
    fn parse_cashu_token() {
        ...
        assert_eq!(parsed.invoice(), None);
        assert_eq!(parsed.node_pubkey(), None);
        assert_eq!(parsed.amount(), Some(Amount::from_sat(50)));
        assert_eq!(
            parsed.cashu_token(),
    ...
    fn parse_cashu_token_no_pad() {
        ...
        assert_eq!(parsed.invoice(), None);
        assert_eq!(parsed.node_pubkey(), None);
        assert_eq!(parsed.amount(), Some(Amount::from_sat(5)));
        assert_eq!(
            parsed.cashu_token(),
